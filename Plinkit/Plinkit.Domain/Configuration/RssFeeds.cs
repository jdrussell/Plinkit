...
namespace Plinkit.Domain.Configuration
{
    public class RssFeeds
    {
        ...
        private const string EntityFrameworkFeed = "https://www.google.co.uk/search?lr=lang_en&hl=en&q=%22entity+framework%22+OR+%22EF5%22+OR+%22EF6%22+OR+linq+-job+-marketing+-blogspot.com&tbm=blg&output=rss&tbs=qdr:d,lr:lang_1en";
        ...
        private const string CleanCodeFeed = "https://www.google.co.uk/search?lr=lang_en&client=firefox-a&hs=EbG&rls=org.mozilla:en-US:official&q=c%23+%22best+practice%22+-job&tbm=blg&output=rss&tbs=qdr:d,lr:lang_1en";
        ...
        private const string UnitTestingFeed = "https://www.google.co.uk/search?lr=lang_en&client=firefox-a&rls=org.mozilla:en-US:official&q=%22unit+test%22+OR+nunit+OR+%22integration+test%22+OR++%22tdd%22+-blogspot.com+-lte&tbm=blg&output=rss&tbs=qdr:d,lr:lang_1en";
        private const string ComputerScienceFeed = "https://www.google.co.uk/search?lr=lang_en&client=firefox-a&rls=org.mozilla:en-US:official&q=%22computer+science%22+OR+%22algorithms%22+OR+%22software+architecture%22+blog+-stackoverflow+-job&tbm=blg&output=rss&tbs=qdr:d,lr:lang_1en";
