...
namespace Plinkit.Domain.Configuration
{
    public class RssFeeds
    {
        ...
        private const string EntityFrameworkFeed = "https://www.google.co.uk/search?lr=lang_en&hl=en&q=%22entity+framework%22+OR+%22EF+5%22+OR+%22EF+6%22+OR+%28linq+AND+c%23%29+-job+-marketing+-blogspot.com+-cnblogs.com&tbm=blg&output=rss&tbs=qdr:d,lr:lang_1en";
        ...
        private const string JavascriptFeed = "https://www.google.co.uk/search?lr=lang_en&hl=en&q=javascript+js+blog+-stackoverflow+-freelancer.com+-tennesseevalleynow.com&tbm=blg&output=rss&tbs=qdr:d,lr:lang_1en";
        private const string CleanCodeFeed = "https://www.google.co.uk/search?lr=lang_en&q=%22clean+code%22+OR+%22professional+software+development%22+OR+%22refactor%22+OR+%22resharper%22+-job+-stackoverflow.com+-consultant+-seev.co.il&lr=lang_en&client=firefox-a&hs=JjT&rls=org.mozilla:en-US:official&tbm=blg&output=rss&tbs=qdr:d,lr:lang_1en";
